...
func NewPromConfig() *PromConfig {
	...
	//TODO: discuss the idea around eradicating the need of admissionReviewLatency by adding the timestamp labels to the kyverno_policy_rule_execution_latency metric
